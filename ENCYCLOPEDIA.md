...
>
> 209 files across 17 categories.
...
| [`progress.md`](progress.md) | Brainstorm→plan→subagent-driven build (spec docs/superpowers/specs/2026-06-20-fmhy-link-harvester-design.md, plan… |
