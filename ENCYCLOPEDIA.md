...
>
> 468 files across 17 categories.
...
| [`docs/superpowers/plans/2026-06-21-stage1-decision-free-fixes.md`](docs/superpowers/plans/2026-06-21-stage1-decision-free-fixes.md) | For agentic workers: REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this… |
...
| [`.codebase-memory/.gitattributes`](.codebase-memory/.gitattributes) | Auto-generated by codebase-memory-mcp Prevent merge conflicts on compressed artifact |
| [`.codebase-memory/artifact.json`](.codebase-memory/artifact.json) | Configuration / data file. |
| [`.codebase-memory/graph.db.zst`](.codebase-memory/graph.db.zst) | ZST file. |
