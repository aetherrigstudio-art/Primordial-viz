...
| general | `debugging-and-error-recovery` | Guides systematic root-cause debugging. |
| general | `documentation-and-adrs` | Records decisions and documentation. |
| general | `frontend-design` | Guidance for distinctive, intentional visual design when building new UI or reshaping an existing one. |
